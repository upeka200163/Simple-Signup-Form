# Simple-Signup-Form
🐼 Interactive Panda Sign-Up Form<br>
A fun, interactive, and modern Sign-Up form built using HTML, CSS, and Vanilla JavaScript. This project features a unique CSS-drawn panda that reacts to user input—specifically covering its eyes when the user types in a password.
